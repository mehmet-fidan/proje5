...
public class Account {
   ...
   //--------------------------------------------------------------------------------------------------
    ...
    public static String transferOtherUser(Users sendingUsers,Users receivingUser, int transferAmount) {

        if (transferAmount > sendingUsers.amountAccount1) {
            return "Sender is poor lol:)";
        } else {
            transferAmount -= transferAmount * (0.02);
            sendingUsers.amountAccount1 -= transferAmount;
